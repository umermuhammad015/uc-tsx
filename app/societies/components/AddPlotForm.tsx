...
export default function AddPlotForm({ society_id }: any) {
    ...
    const [plot_price, setplot_Price] = useState<any>("");
    ...
    const [plot_rent, setplot_Rent] = useState<any>("");
    const [ins_total_price, setIns_total_price] = useState<any>("");
    const [ins_down_payment, setIns_down_payment] = useState<any>("");
    const [ins_possession_Amount, setIns_possession_Amount] = useState<any>("");
    const [ins_period, setIns_Period] = useState<any>("");
